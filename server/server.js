...
app.post("/api/projects", authenticateToken, async (req, res) => {
  ...
  try {
    const [result] = await pool.query(
      "INSERT INTO projects (ProjectName, Description, ProjectStartDate, UserID) VALUES (?, ?, ?, ?)",
...
app.put("/api/projects/:id", authenticateToken, async (req, res) => {
  ...
  try {
    ...
    await pool.query(
      "UPDATE projects SET ProjectName=?, Description=?, ProjectStartDate=? WHERE ProjectID=?",
